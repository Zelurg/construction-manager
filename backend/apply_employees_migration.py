#!/usr/bin/env python3
"""
Скрипт для применения миграции для добавления таблиц employees и daily_executors
...
def apply_migration():
    ...
    migration_file = Path(__file__).parent / 'migrations' / 'add_employees_and_executors.sql'
    ...
    try:
        ...
        cursor.execute("""
            ...
            WHERE type='table' AND (name='employees' OR name='daily_executors')
        """)
        ...
        print("\nТеперь вы можете использовать функционал сотрудников и исполнителей!")
